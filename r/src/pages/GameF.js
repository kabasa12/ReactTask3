...
class GameF extends Component {
    ...
    async onSubmit() {
        ...
        let comm = {
            text: document.getElementById('form17').value
        }
        //console.log(comm)
        ...
        document.getElementById('form17').value = '';
            ...
            <div className="row">
                ...
                <div className="form-group">
                    <div className="md-form mb-4 pink-textarea active-pink-textarea">
                        <label htmlFor="form17">Any comments?</label>
                        <textarea id="form17" className="md-textarea form-control" rows="3" cols="150"></textarea>
                    </div>    
